...
/*#__PURE__*/
function (_Models) {
  _inherits(reviewsModel, _Models);

  function reviewsModel() {
    _classCallCheck(this, reviewsModel);

    return _possibleConstructorReturn(this, _getPrototypeOf(reviewsModel).call(this, _reviews["default"]));
  }

  _createClass(reviewsModel, [{
    key: "insert",
    value: function () {
